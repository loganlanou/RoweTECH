...
export default function GalleryPage() {
  return (
    <>
      ...
      {/* Featured Section */}
      <section className="py-16 2xl:py-24 3xl:py-32 bg-secondary-800">
        <div className="container-custom">
          <div className="text-center mb-12 2xl:mb-16 3xl:mb-20">
            <span className="text-primary-400 font-medium tracking-wider uppercase text-sm 2xl:text-base 3xl:text-lg">Featured</span>
          ...
          <div className="grid md:grid-cols-2 gap-8 2xl:gap-12 3xl:gap-16">
            {featuredImages.map((item, index) => (
              <div key={index} className="group relative rounded-2xl 2xl:rounded-3xl 3xl:rounded-[2rem] overflow-hidden border border-secondary-600 aspect-video">
                <Image
                  src={item.image}
                  alt={item.title}
                  fill
      ...
      {/* Category Filter */}
      <section className="py-8 2xl:py-10 3xl:py-12 bg-secondary-700 border-b border-secondary-600">
        <div className="container-custom">
      ...
      {/* Gallery Grid */}
      <section className="py-16 lg:py-24 2xl:py-32 3xl:py-40 bg-secondary-800">
        <div className="container-custom">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 3xl:grid-cols-5 gap-6 2xl:gap-8 3xl:gap-10">
            {galleryItems.map((item) => (
              <div
                key={item.id}
                className="group rounded-xl 2xl:rounded-2xl 3xl:rounded-3xl overflow-hidden border border-secondary-600 hover:border-primary-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary-500/10"
              >
                <div className="aspect-square relative overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3 2xl:top-4 2xl:left-4 3xl:top-5 3xl:left-5">
                    <span className="bg-primary-600 text-white text-xs 2xl:text-sm 3xl:text-base font-medium px-2 py-1 2xl:px-3 2xl:py-1.5 3xl:px-4 3xl:py-2 rounded 3xl:rounded-lg">
                      {item.category}
                    </span>
                  </div>
                </div>
                <div className="p-4 2xl:p-6 3xl:p-8 bg-secondary-900">
                  <h3 className="font-semibold text-white mb-1 2xl:text-lg 3xl:text-xl group-hover:text-primary-400 transition-colors">{item.title}</h3>
      ...
      <section className="py-16 2xl:py-24 3xl:py-32 relative overflow-hidden">
        ...
        <div className="container-custom relative text-center">
          ...
          <p className="text-secondary-300 text-lg 2xl:text-xl 3xl:text-2xl mb-8 3xl:mb-10 max-w-2xl 2xl:max-w-3xl 3xl:max-w-4xl mx-auto">
