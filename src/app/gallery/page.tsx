...
export default function GalleryPage() {
  return (
    <>
      ...
      <section className="relative pt-32 pb-24 overflow-hidden">
        ...
        <div className="container-custom relative">
          <div className="max-w-3xl">
            <span className="text-primary-400 font-medium tracking-wider uppercase text-sm">Gallery</span>
      ...
      {/* Category Filter */}
      <section className="py-8 bg-secondary-700 border-b border-secondary-600">
        <div className="container-custom">
        ...
        <div className="container-custom">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {galleryItems.map((item) => (
              <div
                key={item.id}
                className="group rounded-xl overflow-hidden border border-secondary-600 hover:border-primary-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary-500/10"
              >
