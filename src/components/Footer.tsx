        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center space-x-3 group mb-6">
              ...
              <div>
                <span className="text-lg font-bold text-white">RoweTech</span>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                <div className="w-10 h-10 rounded-lg bg-secondary-900 border border-secondary-800 flex items-center justify-center text-primary-400 flex-shrink-0">
              ...
              <li>
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-secondary-900 border border-secondary-800 flex items-center justify-center text-primary-400 flex-shrink-0 group-hover:border-primary-500/50 transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-secondary-400 text-sm">Mon-Fri: 7:00 AM - 5:00 PM<br />Sat-Sun: Closed</p>
                </div>
              </li>
            </ul>
        ...
        <div className="border-t border-secondary-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-secondary-500 text-sm">Precision Manufacturing in Wisconsin</span>
            </div>
          </div>
        </div>
      </div>
