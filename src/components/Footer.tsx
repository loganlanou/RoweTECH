...
export default function Footer() {
  return (
    <footer className="bg-secondary-600 border-t border-secondary-500">
      <div className="container-custom py-16 lg:py-20 3xl:py-28">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 3xl:gap-16">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-secondary-200 text-sm 3xl:text-base leading-relaxed mb-6 3xl:mb-8">
              Precision machining, mold repair, and custom tooling solutions for manufacturers across Wisconsin.
            </p>
            <div className="flex items-center space-x-4">
              <div className="w-10 h-10 rounded-lg bg-secondary-500 border border-secondary-400 flex items-center justify-center text-secondary-200 hover:text-primary-400 hover:border-primary-500/50 transition-colors cursor-pointer">
            ...
            <ul className="space-y-3 3xl:space-y-4">
              {navigation.main.map((item) => (
                <li key={item.name}>
                  <Link
                    href={item.href}
                    className="text-secondary-200 hover:text-primary-400 transition-colors duration-200 text-sm 3xl:text-base flex items-center group"
                  >
          ...
          <div>
            ...
            <ul className="space-y-4 3xl:space-y-5">
              <li className="flex items-start space-x-3 3xl:space-x-4">
                <div className="w-10 h-10 3xl:w-12 3xl:h-12 rounded-lg 3xl:rounded-xl bg-secondary-500 border border-secondary-400 flex items-center justify-center text-primary-400 flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-secondary-200 text-sm 3xl:text-base">549 Lavorata Rd<br />Cadott, WI 54727</p>
                </div>
              </li>
              <li>
                <a
                ...
                >
                  <div className="w-10 h-10 3xl:w-12 3xl:h-12 rounded-lg 3xl:rounded-xl bg-secondary-500 border border-secondary-400 flex items-center justify-center text-primary-400 flex-shrink-0 group-hover:border-primary-500/50 transition-colors">
                    <svg className="w-5 h-5 3xl:w-6 3xl:h-6" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                  ...
                  <div>
                    ...
                    <p className="text-secondary-200 text-sm 3xl:text-base group-hover:text-primary-400 transition-colors">(715) 202-3631</p>
                  </div>
                </a>
              </li>
              <li className="flex items-start space-x-3 3xl:space-x-4">
                ...
                <div>
                  ...
                  <p className="text-secondary-200 text-sm 3xl:text-base">Mon-Fri: 7:00 AM - 5:00 PM<br />Sat-Sun: Closed</p>
                </div>
              </li>
            </ul>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-secondary-500 mt-12 3xl:mt-16 pt-8 3xl:pt-10">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-secondary-300 text-sm 3xl:text-base">
            ...
            <div className="flex items-center space-x-2 3xl:space-x-3">
              ...
              <span className="text-secondary-300 text-sm 3xl:text-base">Precision Manufacturing in Wisconsin</span>
            </div>
          </div>
        </div>
      </div>
